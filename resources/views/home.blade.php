...
<section class="relative w-full">
    ...
    <!-- DESKTOP HERO -->
    <img src="{{ asset('images/home/home001.png') }}" alt="Anxietive Hero" class="w-full hidden md:block object-cover">

    <!-- MOBILE HERO -->
    <div class="relative md:hidden h-screen w-full overflow-hidden">

        <img src="{{ asset('images/home/home002.jpg') }}" alt="Anxietive Mobile Hero"
            class="absolute inset-0 w-full h-full object-cover">

        <img src="{{ asset('images/logo/anxietive_logo.PNG') }}" class="absolute bottom-6 left-6 w-20 opacity-95 z-20">
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-6 text-center max-w-2xl">
        ...
        <a href="{{ route('booking') }}" class="inline-block px-10 py-3.5 bg-gray-900 text-white rounded-lg text-lg font-medium
...
<section class="text-center py-12 px-6 md:px-0">
    ...
    <div class="mt-6 text-[10px] md:text-sm text-gray-500 tracking-widest uppercase
