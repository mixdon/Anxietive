                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.configuration') }}"
                            class="flex items-center gap-3 px-4 py-2 rounded-lg font-medium transition min-w-0
       {{ request()->routeIs('admin.configuration*') ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-gray-100' }}"
                            aria-current="{{ request()->routeIs('wadmin.configuration*') ? 'page' : '' }}">

                            <span
                                class="w-8 h-8 flex items-center justify-center rounded-md shrink-0
                   {{ request()->routeIs('admin.configuration*') ? 'bg-purple-200 text-purple-700' : 'text-gray-400' }}">
                                <i class="fa-solid fa-gear fa-fw text-lg" aria-hidden="true"></i>
                            </span>
