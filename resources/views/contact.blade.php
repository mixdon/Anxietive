...
<section class="w-full">
  <div class="grid md:grid-cols-2 gap-0">
    <div>
      <img src="{{ asset('images/contact/contact001.png') }}" 
           alt="Contact Image"
    ...
    <div class="bg-gray-100 p-10 flex flex-col justify-center">
      ...
      <form action="#" method="POST" class="space-y-6">
        ...
        <div class="text-right">
          <button type="submit"
            class="px-6 py-2 bg-indigo-600 text-white font-semibold rounded-md shadow 
                   hover:bg-indigo-700">
            Send
          </button>
        </div>
...
<section class="w-full h-96">
    <iframe
        ...
        style="border:0; filter: grayscale(60%) brightness(97%) contrast(92%);"
