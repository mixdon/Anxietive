...
/*
|--------------------------------------------------------------------------
| BOOKING FORM & STORE (guest bisa isi form, tapi submit butuh login)
|--------------------------------------------------------------------------
*/
...
Route::prefix('admin')->name('admin.')->middleware('auth.admin')->group(function () {
    ...
    // --- Data User & Customer (static view) ---
    Route::view('/data-user', 'admin.data-user')->name('data-user');
    Route::view('/data-customer', 'admin.data-customer')->name('data-customer');
